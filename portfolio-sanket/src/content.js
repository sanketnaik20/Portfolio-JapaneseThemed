export const content = {
  ...
  education: [
    ...
    {
      school: "Rosary Higher Secondary School",
      year: "2020 - 2022",
      degree: "HSE (Science) Goa-Board",
      gpa: "67%"
    }
  ],
  skills: {
  ...
  internship: {
    ...
    location: "Verna, Goa",
    description: "Contributed to 'Moodify', integrating frontend video capture with AI backend.",
    points: [
      "Worked on user auth and live video capture interfaces.",
      "Developed text-based emotion detection using DistilRoBERTa transformer.",
      "Ensured responsive design and UI refinements."
    ],
    repo: "https://github.com/sanketnaik20/Moodify-Internship"
  },
  projects: [
    {
      title: "URL Shortener",
